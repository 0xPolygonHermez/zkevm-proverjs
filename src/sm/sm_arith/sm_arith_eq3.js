	...
	switch(step) {
		case 0: return (
			(p.s[0][_o]   * p.s[0][_o]   - 0xfc2fn  * p.q1[0][_o] )
			    + 0x3f0bcn - p.x1[0][_o]  - p.x2[0][_o]  - p.x3[0][_o] );
		...
		case 2: return (
			...
			(p.s[2][_o]   * p.s[0][_o]   - 0xfffen  * p.q1[0][_o] )
			    + 0x3fff8n - p.x1[2][_o]  - p.x2[2][_o]  - p.x3[2][_o] );
		...
		case 6: return (
			...
			(p.s[6][_o]   * p.s[0][_o]   - 0xffffn  * p.q1[0][_o] )
			    + 0x3fffcn - p.x1[6][_o]  - p.x2[6][_o]  - p.x3[6][_o] );
		...
		case 7: return (
			...
			(p.s[7][_o]   * p.s[0][_o]   - 0xffffn  * p.q1[0][_o] )
			    + 0x3fffcn - p.x1[7][_o]  - p.x2[7][_o]  - p.x3[7][_o] );
		...
		case 8: return (
			...
			(p.s[8][_o]   * p.s[0][_o]   - 0xffffn  * p.q1[0][_o] )
			    + 0x3fffcn - p.x1[8][_o]  - p.x2[8][_o]  - p.x3[8][_o] );
		...
		case 9: return (
			...
			(p.s[9][_o]   * p.s[0][_o]   - 0xffffn  * p.q1[0][_o] )
			    + 0x3fffcn - p.x1[9][_o]  - p.x2[9][_o]  - p.x3[9][_o] );
		...
		case 10: return (
			...
			(p.s[10][_o]  * p.s[0][_o]   - 0xffffn  * p.q1[0][_o] )
			    + 0x3fffcn - p.x1[10][_o] - p.x2[10][_o] - p.x3[10][_o]);
		...
		case 11: return (
			...
			(p.s[11][_o]  * p.s[0][_o]   - 0xffffn  * p.q1[0][_o] )
			    + 0x3fffcn - p.x1[11][_o] - p.x2[11][_o] - p.x3[11][_o]);
		...
		case 12: return (
			...
			(p.s[12][_o]  * p.s[0][_o]   - 0xffffn  * p.q1[0][_o] )
			    + 0x3fffcn - p.x1[12][_o] - p.x2[12][_o] - p.x3[12][_o]);
		...
		case 13: return (
			...
			(p.s[13][_o]  * p.s[0][_o]   - 0xffffn  * p.q1[0][_o] )
			    + 0x3fffcn - p.x1[13][_o] - p.x2[13][_o] - p.x3[13][_o]);
		...
		case 14: return (
			...
			(p.s[14][_o]  * p.s[0][_o]   - 0xffffn  * p.q1[0][_o] )
			    + 0x3fffcn - p.x1[14][_o] - p.x2[14][_o] - p.x3[14][_o]);
		...
		case 15: return (
			...
			(p.s[15][_o]  * p.s[0][_o]   - 0xffffn  * p.q1[0][_o] )
			    + 0x3fffcn - p.x1[15][_o] - p.x2[15][_o] - p.x3[15][_o]);
