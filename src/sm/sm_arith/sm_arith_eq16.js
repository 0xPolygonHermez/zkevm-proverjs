...
module.exports.calculate = function (p, step, _o)
{
	switch(step) {
		case 0: return (
			( - 0xffaaabn * p.q2[0][_o] )
			    + 0x7fd5558n + p.y1[0][_o]  + p.y2[0][_o]  - p.y3[0][_o] );

		case 1: return (
			( - 0xffaaabn * p.q2[1][_o] ) +
			( - 0xffffffn * p.q2[0][_o] )
			    + 0x7fffff8n + p.y1[1][_o]  + p.y2[1][_o]  - p.y3[1][_o] );

		case 2: return (
			( - 0xffaaabn * p.q2[2][_o] ) +
			( - 0xffffffn * p.q2[1][_o] ) +
			( - 0xffb9fen * p.q2[0][_o] )
			    + 0x7fdcff0n + p.y1[2][_o]  + p.y2[2][_o]  - p.y3[2][_o] );
		...
		case 3: return (
			...
			( - 0xffb9fen * p.q2[1][_o] ) +
			( - 0xb153ffn * p.q2[0][_o] )
			    + 0x58a9ff8n + p.y1[3][_o]  + p.y2[3][_o]  - p.y3[3][_o] );
		...
		case 4: return (
			...
			( - 0xb153ffn * p.q2[1][_o] ) +
			( - 0xabfffen * p.q2[0][_o] )
			    + 0x55ffff0n + p.y1[4][_o]  + p.y2[4][_o]  - p.y3[4][_o] );
		...
		case 5: return (
			...
			( - 0xabfffen * p.q2[1][_o] ) +
			( - 0xf6241en * p.q2[0][_o] )
			    + 0x7b120f0n + p.y1[5][_o]  + p.y2[5][_o]  - p.y3[5][_o] );
		...
		case 6: return (
			...
			( - 0xf6241en * p.q2[1][_o] ) +
			( - 0xa0f6b0n * p.q2[0][_o] )
			    + 0x507b580n + p.y1[6][_o]  + p.y2[6][_o]  - p.y3[6][_o] );
		...
		case 7: return (
			...
			( - 0xa0f6b0n * p.q2[1][_o] ) +
			( - 0x6730d2n * p.q2[0][_o] )
			    + 0x3398690n + p.y1[7][_o]  + p.y2[7][_o]  - p.y3[7][_o] );
		...
		case 8: return (
			...
			( - 0x6730d2n * p.q2[1][_o] ) +
			( - 0x8512bfn * p.q2[0][_o] )
			    + 0x42895f8n + p.y1[8][_o]  + p.y2[8][_o]  - p.y3[8][_o] );
		...
		case 9: return (
			...
			( - 0x8512bfn * p.q2[1][_o] ) +
			( - 0x4b84f3n * p.q2[0][_o] )
			    + 0x25c2798n + p.y1[9][_o]  + p.y2[9][_o]  - p.y3[9][_o] );
		...
		case 10: return (
			...
			( - 0x4b84f3n * p.q2[1][_o] ) +
			( - 0xd76477n * p.q2[0][_o] )
			    + 0x6bb23b8n + p.y1[10][_o] + p.y2[10][_o] - p.y3[10][_o]);
		...
		case 11: return (
			...
			( - 0xd76477n * p.q2[1][_o] ) +
			( - 0x434bacn * p.q2[0][_o] )
			    + 0x21a5d60n + p.y1[11][_o] + p.y2[11][_o] - p.y3[11][_o]);
		...
		case 12: return (
			...
			( - 0x434bacn * p.q2[1][_o] ) +
			( - 0x1ba7b6n * p.q2[0][_o] )
			    + 0xdd3db0n + p.y1[12][_o] + p.y2[12][_o] - p.y3[12][_o]);
		...
		case 13: return (
			...
			( - 0x1ba7b6n * p.q2[1][_o] ) +
			( - 0xe69a4bn * p.q2[0][_o] )
			    + 0x734d258n + p.y1[13][_o] + p.y2[13][_o] - p.y3[13][_o]);
		...
		case 14: return (
			...
			( - 0xe69a4bn * p.q2[1][_o] ) +
			( - 0xea397fn * p.q2[0][_o] )
			    + 0x751cbf8n + p.y1[14][_o] + p.y2[14][_o] - p.y3[14][_o]);
		...
		case 15: return (
			...
			( - 0xea397fn * p.q2[1][_o] ) +
			( - 0x1a0111n * p.q2[0][_o] )
			    + 0xd00888n + p.y1[15][_o] + p.y2[15][_o] - p.y3[15][_o]);
