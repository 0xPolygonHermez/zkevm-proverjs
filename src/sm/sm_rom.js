    ...
    for (let i=0; i<N; i++) {
        ...
        */
        ...
        pols.operations[i] =
            ...
            + (rom.program[pIndex].hashS ? (2n**47n * BigInt(rom.program[pIndex].hashS)) : 0n)
            + (rom.program[pIndex].hashSDigest ? (2n**48n * BigInt(rom.program[pIndex].hashSDigest)) : 0n)
            + (rom.program[pIndex].hashSLen ? (2n**49n * BigInt(rom.program[pIndex].hashSLen)) : 0n)
            + (rom.program[pIndex].hashS1 ? (2n**50n * BigInt(rom.program[pIndex].hashS1)) : 0n)
