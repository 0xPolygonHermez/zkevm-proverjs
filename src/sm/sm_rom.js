    ...
    for (let i=0; i<N; i++) {
        ...
        */
        ...
        pols.operations[i] =
            ...
            + (rom.program[pIndex].inFREE ? (2n**47n * BigInt(rom.program[pIndex].inFREE)) : 0n)
            + (rom.program[pIndex].inFREE0 ? (2n**48n * BigInt(rom.program[pIndex].inFREE0)) : 0n);
