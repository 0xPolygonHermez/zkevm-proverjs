...
const argv = require("yargs")
    .version(version)
    .usage("main_executor <input.json> -r <rom.json> -o <proof.json> -t <test.json> -l <logs.json> -s -d [-p <main.pil>] [-P <pilconfig.json>] -u -e -v -T --nc")
    .alias("o", "output")
    .alias("r", "rom")
    .alias("t", "test")
    .alias("l", "logs")
...
async function run() {
    ...
    const config = {
        ...
        nocounters: (argv.nocounters === true)
    }
