...
const smPoseidonG = require("../src/sm/sm_byte4.js");


describe("test byte4 state machine", async function () {
    this.timeout(10000000);

    it("It should check standard l", async () => {
        const F = new F1Field("0xFFFFFFFF00000001");

        const pil = await compile(F, "main_byte4.pil");
        ...
        await smByte4.buildConstants(constPols);
        await smByte4.execute(cmPols, input);
